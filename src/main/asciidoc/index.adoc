...
Sample application demonstranding how to use Spring REST Docs with JUnit 5.

'BeerOrderControllerTest' makes a call to a very sample service and produces three documentation snippets.
...
include::{snippets}/v1/beer-get/hhtp-response.adoc[]
